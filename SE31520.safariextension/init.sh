...
ANIMATIONS_CSS_PATH="$CSS_PATH/animate.css"
...
ANIMATIONS_CSS_URL="https://raw.githubusercontent.com/daneden/animate.css/master/animate.css"
...
if [ ! -f $ANIMATIONS_CSS_PATH ]
then
	echo "Downloading Animations CSS"
	wget -O $ANIMATIONS_CSS_PATH $ANIMATIONS_CSS_URL
else
	echo "Animations CSS Already exists"
fi
