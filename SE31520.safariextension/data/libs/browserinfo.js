 ...
 * File:    browserinfo.js
 * Desc:    This is a utility class to detect which browser is in use.
 */
...
if ((verOffset=nVend.indexOf("Opera"))!=-1) {
    browserName = "Opera";
...
else if (navigator.appVersion.indexOf('Trident/') > 0 || (verOffset=nAgt.indexOf("MSIE"))!=-1) {
